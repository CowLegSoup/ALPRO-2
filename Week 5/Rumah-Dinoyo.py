...
# Main analysis
print("1. Fastest path from Rumah (Lobby, 0) to UKWMS Dinoyo (15) using BFS:")
bfs_path = bfs_shortest_path(graph, 0, 15)
...
print("\n2. All paths from Rumah (Lobby, 0) to UKWMS Dinoyo (15) using DFS:")
dfs_all_paths = dfs_paths(graph, 0, 15)
